      ...
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-2">
            ...
            {/* Section 2: Assign to Household */}
            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Assign to Household</p>
            <FormField control={form.control} name="household_id" render={({ field }) => (
              <FormItem>
            ...
            <Button type="submit" className="w-full" disabled={createMember.isPending}>
              {createMember.isPending ? "Creating..." : "Create Contact"}
            </Button>
          </form>
        </Form>
      </DialogContent>
